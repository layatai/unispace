...
public enum PortableInputMapper {
    ...
    public static func map(_ event: InputEvent) -> PortableInputEvent? {
        ...
        case let .gesture(_, portable):
            portable.map(PortableInputEvent.gesture)
    ...
    public static let keyCodeToHIDUsage: [UInt16: UInt16] = [
        ...
        6: 0x1D, 7: 0x1B, 8: 0x06, 9: 0x19, 10: 0x64, 11: 0x05, 12: 0x14,
        ...
        49: 0x2C, 50: 0x35, 51: 0x2A, 53: 0x29, 64: 0x6C,
        65: 0x63, 67: 0x55, 69: 0x57, 71: 0x53, 75: 0x54, 76: 0x58,
        78: 0x56, 79: 0x6D, 80: 0x6E, 81: 0x67, 82: 0x62, 83: 0x59,
        84: 0x5A, 85: 0x5B, 86: 0x5C, 87: 0x5D, 88: 0x5E, 89: 0x5F,
        90: 0x6F, 91: 0x60, 92: 0x61, 93: 0x89, 94: 0x87, 95: 0x85,
        96: 0x3E, 97: 0x3F, 98: 0x40, 99: 0x3C, 100: 0x41,
        101: 0x42, 102: 0x91, 103: 0x44, 104: 0x90, 105: 0x68,
        106: 0x6B, 107: 0x69, 109: 0x43, 110: 0x65, 111: 0x45,
        113: 0x6A, 114: 0x49, 115: 0x4A,
